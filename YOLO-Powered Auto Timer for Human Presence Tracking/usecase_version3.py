...
def run(
    weights=ROOT / "runs\train\exp4\weights\best.pt",  # model path or triton URL
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                if timer_running:
                    ...
                    print(f"Class 0 detected. Timer stopped. Total elapsed time: {total_elapsed_time:.2f} seconds.")
                print(det)
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    org = (10, 40)  # Position of the text
                    im0 = cv2.putText(im0, "{:.2f}s".format(total_elapsed_time), org, font, font_scale, color, thickness, cv2.LINE_AA)
                ...
                if  timer_running == False:
                    start_time = time.time()
                    timer_running = True
                    print(f"Class 0 not detected. Timer started. Total elapsed time: {total_elapsed_time:.2f} seconds.")
